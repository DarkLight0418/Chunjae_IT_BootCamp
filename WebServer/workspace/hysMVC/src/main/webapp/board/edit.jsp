...
input[type="submit"], input[type="reset"] { padding: 8px 16px; background-color: #4CAF50; color: white; border: none; border-radius: 4px; cursor: pointer; margin: 5px; }
...
#content { width: 95%; height: 200px; padding: 8px; border: 1px solid #ccc; border-radius: 4px; resize: vertical; vertical-align: top; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; font-size: 14px; line-height: 1.5; }
</style>

<body onload="document.f.writer.focus()">
<center>
<h1>게시글 수정</h1>
<form name="f" action="board.do?m=update" method="post">
