...
-- 테이블 데이터 newbiehealth.diet_template_detail:~10 rows (대략적) 내보내기
INSERT INTO `diet_template_detail` (`id`, `template_id`, `food_id`, `quantity`) VALUES
	(1, 1, 1, 2),
	(2, 1, 3, 3),
	(3, 2, 5, 1),
	(4, 2, 2, 4),
...
INSERT INTO `exercise` (`exercise_id`, `exercise_name`, `type`, `target_muscle`, `body_part`, `difficulty`, `image_url`, `video_url`) VALUES
	...
	(2, '체스트 프레스 머신', 'MACHINE', '대흉근, 전면삼각근, 상완삼두근', 'CHEST', 1, NULL, 'https://img.youtube.com/vi/NoQ27VKgnvA/0.jpg\n'),
	(3, '펙덱 머신', 'MACHINE', '대흉근(내측), 소흉근', 'CHEST', 2, NULL, 'https://img.youtube.com/vi/bo6ZlZ_qL48/0.jpg\n'),
	(4, '케이블 크로스 오버', 'CABLE', '대흉근, 소흉근', 'CHEST', 2, NULL, 'https://img.youtube.com/vi/0HC3x4xxfd4/0.jpg\n'),
	(5, '딥스 머신', 'MACHINE', '대흉근(하부), 상완삼두근, 전면삼각근', 'CHEST', 3, 'N', 'https://img.youtube.com/vi/YqeQ3D9Ai50/0.jpg\n'),
	...
	(150, '클로즈 스쿼트', 'BODYWEIGHT', '대퇴사두근, 내전근', NULL, 5, 'N', 'N'),
	(151, '내전 리프트', 'BODYWEIGHT', '내전근', NULL, 4, 'N', 'N'),
	(152, '사이드 레그 라이즈', 'BODYWEIGHT', ' 중둔근, 소둔근', NULL, 2, 'N', 'N'),
	(153, '스탠딩 카프 레이즈', 'BODYWEIGHT', '비복근', NULL, 5, 'N', 'N'),
	(154, '점프잭', 'MACHINE', '전신(비복근, 대퇴사두근 등)', NULL, 5, 'N', 'N'),
	(155, '런닝머신', 'MACHINE', '대퇴사두근, 햄스트링, 대둔근, 비복근, 가자미근, 심폐지구력', NULL, 6, 'N', 'N'),
	(156, '리컴번트 바이크', 'MACHINE', '대퇴사두근, 햄스트링, 대둔근, 비복근, 가자미근', NULL, 5, 'N', 'N'),
	(157, '업라이트 바이크', 'MACHINE', '대퇴사두근, 햄스트링, 대둔근, 비복근, 가자미근', NULL, 2, 'N', 'N'),
	(158, '스피닝 바이크', 'MACHINE', '대퇴사두근, 햄스트링, 대둔근, 비복근, 가자미근', NULL, 7, 'N', 'N'),
	(159, '스텝밀', 'MACHINE', '대퇴사두근, 햄스트링, 대둔근, 비복근, 가자미근', NULL, 5, 'N', 'N'),
	(160, '미니 스텝퍼', 'MACHINE', '대퇴사두근, 햄스트링, 대둔근, 비복근, 가자미근', NULL, 2, 'N', 'N'),
	(161, '클라이머 머신', 'MACHINE', '대퇴사두근, 햄스트링, 대둔근, 비복근, 가자미근, 전신유산소', NULL, 6, 'N', 'N'),
	(162, '일리티컬 머신', 'MACHINE', '대퇴사두근, 햄스트링, 대둔근, 비복근, 가자미근, 전완근', NULL, 5, 'N', 'N'),
	(163, '로잉머신', 'MACHINE', ' 광배근, 승모근, 능형근, 상완이두근, 대퇴사두근, 햄스트링, 대둔근, 비복근', NULL, 3, 'N', 'N'),
	(164, '트레드클라이머', 'MACHINE', '대퇴사두근, 햄스트링, 대둔근, 비복근, 가자미근', NULL, 2, 'N', 'N'),
	(165, '에어 바이크', 'MACHINE', '대퇴사두근, 햄스트링, 대둔근, 비복근, 상완이두근, 상완삼두근, 어깨', NULL, 2, 'N', 'N'),
	(166, '커브 러닝머신', 'MACHINE', '대퇴사두근, 햄스트링, 대둔근, 비복근, 가자미근', NULL, 2, 'N', 'N'),
	(167, '점프 트램폴린', 'MACHINE', '대퇴사두근, 햄스트링, 대둔근, 비복근, 코어근육(복직근, 외복사근)', NULL, 1, 'N', 'N');
...
INSERT INTO `food` (`food_id`, `food_name`, `food_carbohydrate`, `food_protein`, `food_fat`, `food_calories`, `food_type`) VALUES
	...
	(6, '바나나', 27, 1, 0, 105, '과일'),
	(7, '아몬드', 6, 6, 14, 160, '간식'),
	(8, '그릭요거트', 9, 10, 4, 100, '간식'),
	(9, '브로콜리', 7, 3, 0, 55, '채소'),
	(10, '닭강정', 28, 15, 8, 300, '음식');
...
-- 테이블 데이터 newbiehealth.routine_exercise_detail:~10 rows (대략적) 내보내기
...
INSERT INTO `statistics` (`id`, `user_key`, `date`, `day_of_week`, `workout_count`, `goal_achievement_rate`, `calories_burned`, `muscle_strength`, `body_fat_before`, `body_fat_after`, `muscle_mass_before`, `muscle_mass_after`, `created_at`, `daily_calorie_goal`, `activity_minutes`, `dominant_equipment`, `dominant_equipment_text`) VALUES
	(1, 'U001', '2025-07-28', 'Mon', 1, 80, 320, 240, 24.0, 23.8, 28.8, 29.0, '2025-07-28 00:00:00', 400, 40, NULL, '{\r\n  "MACHINE": {"count": 2, "minutes": 25},\r\n  "BODYWEIGHT": {"count": 1, "minutes": 15}\r\n}'),
	(2, 'U001', '2025-07-29', 'Tue', 2, 85, 143, 242, 23.8, 23.6, 29.0, 29.2, '2025-07-29 00:00:00', 400, 45, NULL, '{\r\n  "MACHINE": {"count": 1, "minutes": 20},\r\n  "CABLE": {"count": 2, "minutes": 25}\r\n}'),
	(3, 'U001', '2025-07-30', 'Wed', 1, 78, 310, 245, 23.6, 23.4, 29.2, 29.4, '2025-07-30 00:00:00', 400, 40, NULL, '{\r\n  "BODYWEIGHT": {"count": 3, "minutes": 40}\r\n}'),
	(4, 'U001', '2025-07-31', 'Thu', 2, 90, 345, 247, 23.4, 23.1, 29.4, 29.7, '2025-07-31 00:00:00', 400, 50, NULL, '{\r\n  "MACHINE": {"count": 1, "minutes": 20},\r\n  "BARBEL": {"count": 2, "minutes": 30}\r\n}'),
	(5, 'U001', '2025-08-01', 'Fri', 1, 70, 330, 243, 23.1, 22.9, 29.7, 29.9, '2025-08-01 00:00:00', 400, 50, NULL, '{\r\n  "MACHINE": {"count": 3, "minutes": 50}\r\n}'),
	(6, 'U001', '2025-08-02', 'Sat', 2, 88, 340, 248, 22.9, 22.7, 29.9, 30.2, '2025-08-02 00:00:00', 400, 70, NULL, '{\r\n  "MACHINE": {"count": 2, "minutes": 30},\r\n  "BODYWEIGHT": {"count": 2, "minutes": 40}\r\n}'),
	(7, 'U001', '2025-08-03', 'Sun', 1, 75, 330, 250, 22.7, 22.5, 30.2, 30.4, '2025-08-03 00:00:00', 400, 45, NULL, '{\r\n  "BARBEL": {"count": 2, "minutes": 25},\r\n  "CABLE": {"count": 1, "minutes": 20}\r\n}');
...
INSERT INTO `user` (`user_key`, `user_id`, `password`, `name`, `age`, `gender`, `height_cm`, `weight_kg`, `fitness_level`, `goal`, `created_at`) VALUES
	('U001', 'test01', '1234', '홍길동', 25, '남', 175.5, 70, 1, '다이어트', '2025-07-30'),
